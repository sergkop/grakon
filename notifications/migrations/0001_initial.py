...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NotificationRecipient'
        db.create_table('notifications_notificationrecipient', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('notification', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recipients', to=orm['notifications.Notification'])),
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications', to=orm['users.Profile'])),
        ...
        db.send_create_signal('notifications', ['NotificationRecipient'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'NotificationRecipient'
        db.delete_table('notifications_notificationrecipient')
    ...
    models = {
        ...
        'notifications.notificationrecipient': {
            ...
            'notification': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'recipients'", 'to': "orm['notifications.Notification']"}),
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notifications'", 'to': "orm['users.Profile']"})
        },
