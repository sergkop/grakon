...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.rating'
        db.alter_column('tasks_task', 'rating', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Task.rating'
        db.alter_column('tasks_task', 'rating', self.gf('django.db.models.fields.IntegerField')())
