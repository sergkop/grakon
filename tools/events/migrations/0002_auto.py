...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Event', fields ['event_time']
        db.create_index('events_event', ['event_time'])

    def backwards(self, orm):
        # Removing index on 'Event', fields ['event_time']
        db.delete_index('events_event', ['event_time'])
    ...
    models = {
        ...
        'events.event': {
            ...
            'event_time': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
