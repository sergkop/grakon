...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('projects_project', (
            ...
            ('deadline', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('goals', self.gf('elements.models.HTMLField')()),
            ('stages', self.gf('elements.models.HTMLField')(blank=True)),
            ('about', self.gf('elements.models.HTMLField')(blank=True)),
            ('team', self.gf('elements.models.HTMLField')(blank=True)),
        ))
    ...
    models = {
        ...
        'users.profile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intro': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
