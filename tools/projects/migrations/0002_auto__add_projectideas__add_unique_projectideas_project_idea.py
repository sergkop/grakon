...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectIdeas'
        db.create_table('projects_projectideas', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ideas', to=orm['projects.Project'])),
            ('idea', self.gf('django.db.models.fields.related.ForeignKey')(related_name='projects', to=orm['ideas.Idea'])),
        ))
        db.send_create_signal('projects', ['ProjectIdeas'])

        # Adding unique constraint on 'ProjectIdeas', fields ['project', 'idea']
        db.create_unique('projects_projectideas', ['project_id', 'idea_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectIdeas', fields ['project', 'idea']
        db.delete_unique('projects_projectideas', ['project_id', 'idea_id'])

        # Deleting model 'ProjectIdeas'
        db.delete_table('projects_projectideas')
    ...
    models = {
        ...
        'ideas.idea': {
            ...
            'description': ('elements.models.HTMLField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rating': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ideas'", 'to': "orm['tasks.Task']"}),
        ...
        'projects.project': {
            ...
            'about': ('elements.models.HTMLField', [], {}),
            'add_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'deadline': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'goals': ('elements.models.HTMLField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rating': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'stages': ('elements.models.HTMLField', [], {'blank': 'True'}),
            'team': ('elements.models.HTMLField', [], {'blank': 'True'}),
            'time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '250'})
        },
        'projects.projectideas': {
            'Meta': {'unique_together': "(('project', 'idea'),)", 'object_name': 'ProjectIdeas'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idea': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'projects'", 'to': "orm['ideas.Idea']"}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ideas'", 'to': "orm['projects.Project']"})
        },
