...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.stages'
        db.delete_column('projects_project', 'stages')


    def backwards(self, orm):
        # Adding field 'Project.stages'
        db.add_column('projects_project', 'stages',
                      self.gf('elements.models.HTMLField')(default='', blank=True),
                      keep_default=False)
