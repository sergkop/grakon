...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Idea.rating'
        db.alter_column('ideas_idea', 'rating', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Idea.rating'
        db.alter_column('ideas_idea', 'rating', self.gf('django.db.models.fields.IntegerField')())
