...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Idea.task'
        db.add_column('ideas_idea', 'task',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['tasks.Task']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Idea.task'
        db.delete_column('ideas_idea', 'task_id')
