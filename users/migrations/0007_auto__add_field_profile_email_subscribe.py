...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.email_subscribe'
        db.add_column('users_profile', 'email_subscribe',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.email_subscribe'
        db.delete_column('users_profile', 'email_subscribe')
    ...
    models = {
        ...
        'users.profile': {
            ...
            'email_subscribe': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
