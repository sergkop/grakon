...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.main_location'
        db.delete_column('users_profile', 'main_location_id')

    def backwards(self, orm):
        # Adding field 'Profile.main_location'
        db.add_column('users_profile', 'main_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='profiles', null=True, to=orm['elements.EntityLocation'], blank=True),
                      keep_default=False)
