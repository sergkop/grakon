...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.show_name'
        db.delete_column('users_profile', 'show_name')


    def backwards(self, orm):
        # Adding field 'Profile.username'
        db.add_column('users_profile', 'username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, db_index=True),
                      keep_default=False)

        # Adding field 'Profile.show_name'
        db.add_column('users_profile', 'show_name',
