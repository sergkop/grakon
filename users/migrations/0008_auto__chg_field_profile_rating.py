...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.rating'
        db.alter_column('users_profile', 'rating', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Profile.rating'
        db.alter_column('users_profile', 'rating', self.gf('django.db.models.fields.IntegerField')())
