...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_profile', (
            ...
            ('show_name', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('about', self.gf('tinymce.models.HTMLField')(default='', blank=True)),
            ('main_location', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='profiles', null=True, to=orm['elements.EntityLocation'])),
        ))
