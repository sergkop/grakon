...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_personresource', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='resources', to=orm['users.Profile'])),
            ('resource', self.gf('django.db.models.fields.CharField')(max_length=20, db_index=True)),
        ))
        db.send_create_signal('users', ['PersonResource'])

        # Adding unique constraint on 'PersonResource', fields ['profile', 'resource']
        db.create_unique('users_personresource', ['profile_id', 'resource'])

    def backwards(self, orm):
        # Removing unique constraint on 'PersonResource', fields ['profile', 'resource']
        db.delete_unique('users_personresource', ['profile_id', 'resource'])

        # Deleting model 'Profile'
        db.delete_table('users_profile')

        # Deleting model 'PersonResource'
        db.delete_table('users_personresource')
