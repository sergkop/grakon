...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_personlocation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='locations', to=orm['users.Profile'])),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='users', to=orm['locations.Location'])),
        ...
        db.send_create_signal('users', ['PersonLocation'])

        # Adding unique constraint on 'PersonLocation', fields ['profile', 'location']
        db.create_unique('users_personlocation', ['profile_id', 'location_id'])

        # Adding index on 'Profile', fields ['time']
        db.create_index('users_profile', ['time'])

        # Adding index on 'PersonResource', fields ['time']
        db.create_index('users_personresource', ['time'])

    def backwards(self, orm):
        # Removing index on 'PersonResource', fields ['time']
        db.delete_index('users_personresource', ['time'])

        # Removing index on 'Profile', fields ['time']
        db.delete_index('users_profile', ['time'])

        # Removing unique constraint on 'PersonLocation', fields ['profile', 'location']
        db.delete_unique('users_personlocation', ['profile_id', 'location_id'])

        # Deleting model 'PersonLocation'
        db.delete_table('users_personlocation')
