...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Email.read_time'
        db.alter_column('services_email', 'read_time', self.gf('django.db.models.fields.DateTimeField')(null=True))
    def backwards(self, orm):

        # Changing field 'Email.read_time'
        db.alter_column('services_email', 'read_time', self.gf('django.db.models.fields.DateTimeField')())
    models = {
        'auth.group': {
