...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Email.recipient'
        db.alter_column('services_email', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'], null=True))

        # Changing field 'Email.type'
        db.alter_column('services_email', 'type', self.gf('django.db.models.fields.CharField')(max_length=20))
    def backwards(self, orm):

        # Changing field 'Email.recipient'
        db.alter_column('services_email', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile']))

        # Changing field 'Email.type'
        db.alter_column('services_email', 'type', self.gf('django.db.models.fields.CharField')(max_length=10))
    models = {
        'auth.group': {
        ...
        'services.email': {
            ...
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['users.Profile']", 'null': 'True', 'blank': 'True'}),
