...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InitiativeGroup.locations'
        db.delete_column('referendum_initiativegroup', 'locations_id')

        # Adding field 'InitiativeGroup.location'
        db.add_column('referendum_initiativegroup', 'location',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'InitiativeGroup.locations'
        raise RuntimeError("Cannot reverse this migration. 'InitiativeGroup.locations' and its values cannot be restored.")
        # Deleting field 'InitiativeGroup.location'
        db.delete_column('referendum_initiativegroup', 'location_id')
    ...
    models = {
        ...
        'referendum.initiativegroup': {
            'Meta': {'object_name': 'InitiativeGroup'},
