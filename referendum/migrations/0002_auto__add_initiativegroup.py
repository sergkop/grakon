...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InitiativeGroup'
        db.create_table('referendum_initiativegroup', (
            ...
            ('locations', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'])),
        ))
        db.send_create_signal('referendum', ['InitiativeGroup'])


    def backwards(self, orm):
        # Deleting model 'InitiativeGroup'
        db.delete_table('referendum_initiativegroup')
    ...
    models = {
        ...
        'referendum.initiativegroup': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locations': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['locations.Location']"}),
