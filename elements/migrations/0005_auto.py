...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'EntityResource', fields ['entity_id']
        db.create_index('elements_entityresource', ['entity_id'])

        # Adding index on 'EntityFollower', fields ['entity_id']
        db.create_index('elements_entityfollower', ['entity_id'])

        # Adding index on 'EntityLocation', fields ['entity_id']
        db.create_index('elements_entitylocation', ['entity_id'])

    def backwards(self, orm):
        # Removing index on 'EntityLocation', fields ['entity_id']
        db.delete_index('elements_entitylocation', ['entity_id'])

        # Removing index on 'EntityFollower', fields ['entity_id']
        db.delete_index('elements_entityfollower', ['entity_id'])

        # Removing index on 'EntityResource', fields ['entity_id']
        db.delete_index('elements_entityresource', ['entity_id'])
