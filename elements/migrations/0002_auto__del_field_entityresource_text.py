...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EntityResource.text'
        db.delete_column('elements_entityresource', 'text')

    def backwards(self, orm):
        # Adding field 'EntityResource.text'
        db.add_column('elements_entityresource', 'text',
