...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'EntityLocation', fields ['is_main']
        db.create_index('elements_entitylocation', ['is_main'])

    def backwards(self, orm):
        # Removing index on 'EntityLocation', fields ['is_main']
        db.delete_index('elements_entitylocation', ['is_main'])
