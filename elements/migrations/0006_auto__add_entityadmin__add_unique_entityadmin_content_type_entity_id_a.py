...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('elements_entityadmin', (
            ...
            ('admin', self.gf('django.db.models.fields.related.ForeignKey')(related_name='admins', to=orm['users.Profile'])),
        ))
        db.send_create_signal('elements', ['EntityAdmin'])

        # Adding unique constraint on 'EntityAdmin', fields ['content_type', 'entity_id', 'admin']
        db.create_unique('elements_entityadmin', ['content_type_id', 'entity_id', 'admin_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'EntityAdmin', fields ['content_type', 'entity_id', 'admin']
        db.delete_unique('elements_entityadmin', ['content_type_id', 'entity_id', 'admin_id'])

        # Deleting model 'EntityAdmin'
        db.delete_table('elements_entityadmin')
    ...
    models = {
        ...
        'elements.entityadmin': {
            'Meta': {'unique_together': "(('content_type', 'entity_id', 'admin'),)", 'object_name': 'EntityAdmin'},
            'admin': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'admins'", 'to': "orm['users.Profile']"}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
