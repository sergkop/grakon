...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'EntityParticipant', fields ['profile', 'entity_id', 'role', 'content_type']
        db.delete_unique('participants_entityparticipant', ['profile_id', 'entity_id', 'role', 'content_type_id'])

        # Deleting field 'EntityParticipant.profile'
        db.delete_column('participants_entityparticipant', 'profile_id')

        # Adding field 'EntityParticipant.person'
        db.add_column('participants_entityparticipant', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='participates_in', to=orm['users.Profile']),
                      keep_default=False)

        # Adding unique constraint on 'EntityParticipant', fields ['person', 'entity_id', 'role', 'content_type']
        db.create_unique('participants_entityparticipant', ['person_id', 'entity_id', 'role', 'content_type_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'EntityParticipant', fields ['person', 'entity_id', 'role', 'content_type']
        db.delete_unique('participants_entityparticipant', ['person_id', 'entity_id', 'role', 'content_type_id'])

        # Adding field 'EntityParticipant.profile'
        db.add_column('participants_entityparticipant', 'profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='participates_in', to=orm['users.Profile']),
                      keep_default=False)

        # Deleting field 'EntityParticipant.person'
        db.delete_column('participants_entityparticipant', 'person_id')

        # Adding unique constraint on 'EntityParticipant', fields ['profile', 'entity_id', 'role', 'content_type']
        db.create_unique('participants_entityparticipant', ['profile_id', 'entity_id', 'role', 'content_type_id'])
