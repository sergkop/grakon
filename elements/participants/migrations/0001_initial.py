...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EntityParticipant'
        db.create_table('participants_entityparticipant', (
            ...
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='participates_in', to=orm['users.Profile'])),
            ('role', self.gf('django.db.models.fields.CharField')(max_length=8)),
        ))
        db.send_create_signal('participants', ['EntityParticipant'])

        # Adding unique constraint on 'EntityParticipant', fields ['content_type', 'entity_id', 'profile', 'role']
        db.create_unique('participants_entityparticipant', ['content_type_id', 'entity_id', 'profile_id', 'role'])

    def backwards(self, orm):
        # Removing unique constraint on 'EntityParticipant', fields ['content_type', 'entity_id', 'profile', 'role']
        db.delete_unique('participants_entityparticipant', ['content_type_id', 'entity_id', 'profile_id', 'role'])

        # Deleting model 'EntityParticipant'
        db.delete_table('participants_entityparticipant')
    ...
    models = {
        ...
        'participants.entityparticipant': {
            'Meta': {'unique_together': "(('content_type', 'entity_id', 'profile', 'role'),)", 'object_name': 'EntityParticipant'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'entity_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'participates_in'", 'to': "orm['users.Profile']"}),
