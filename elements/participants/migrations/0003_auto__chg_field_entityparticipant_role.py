...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntityParticipant.role'
        db.alter_column('participants_entityparticipant', 'role', self.gf('django.db.models.fields.CharField')(max_length=11))
    def backwards(self, orm):

        # Changing field 'EntityParticipant.role'
        db.alter_column('participants_entityparticipant', 'role', self.gf('django.db.models.fields.CharField')(max_length=8))
    models = {
        'auth.group': {
