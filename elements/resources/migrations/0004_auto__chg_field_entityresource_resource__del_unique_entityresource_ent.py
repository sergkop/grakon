...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'EntityResource', fields ['entity_id', 'resource', 'content_type']
        db.delete_unique('resources_entityresource', ['entity_id', 'resource', 'content_type_id'])


        # Changing field 'EntityResource.resource'
        db.alter_column('resources_entityresource', 'resource', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Adding unique constraint on 'EntityResource', fields ['entity_id', 'resource', 'content_type', 'provider']
        db.create_unique('resources_entityresource', ['entity_id', 'resource', 'content_type_id', 'provider_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EntityResource', fields ['entity_id', 'resource', 'content_type', 'provider']
        db.delete_unique('resources_entityresource', ['entity_id', 'resource', 'content_type_id', 'provider_id'])


        # Changing field 'EntityResource.resource'
        db.alter_column('resources_entityresource', 'resource', self.gf('django.db.models.fields.CharField')(max_length=20))
        # Adding unique constraint on 'EntityResource', fields ['entity_id', 'resource', 'content_type']
        db.create_unique('resources_entityresource', ['entity_id', 'resource', 'content_type_id'])
