...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntityResource.provider'
        db.add_column('resources_entityresource', 'provider',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='provided_resources', null=True, to=orm['users.Profile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntityResource.provider'
        db.delete_column('resources_entityresource', 'provider_id')
