...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntityResource.description'
        db.add_column('resources_entityresource', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=140),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntityResource.description'
        db.delete_column('resources_entityresource', 'description')
