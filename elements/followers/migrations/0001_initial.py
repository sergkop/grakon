...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('elements_entityfollower', 'followers_entityfollower')

        if not db.dry_run:
            # For permissions to work properly after migrating
            orm['contenttypes.contenttype'].objects.filter(app_label='elements', model='EntityFollower').update(app_label='elements.followers')

    def backwards(self, orm):
        db.rename_table('followers_entityfollower', 'elements_entityfollower')
        if not db.dry_run:
            # For permissions to work properly after migrating
            orm['contenttypes.contenttype'].objects.filter(app_label='elements.followers', model='EntityFollower').update(app_label='elements')
