...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EntityComment'
        db.create_table('comments_entitycomment', (
            ...
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['users.Profile'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comments.EntityComment'], null=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('comments', ['EntityComment'])


    def backwards(self, orm):
        # Deleting model 'EntityComment'
        db.delete_table('comments_entitycomment')
